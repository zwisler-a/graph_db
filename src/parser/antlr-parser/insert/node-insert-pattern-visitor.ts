...
import {CreateNodeBuilder} from "../../../query/create-graph/create-graph-builder";
import {PropertyVisitor} from "../property/property-visitor";

export class NodeInsertPatternVisitor extends GQLVisitor<CreateNodeBuilder | null> {

    constructor(private nodeBuilder: CreateNodeBuilder) {
        super();
    }
